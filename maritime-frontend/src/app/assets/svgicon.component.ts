...
@Component({
  ...
  template: `
    <ng-container [ngSwitch]="icon">
      ...
      >
        <g>
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M1106.987,13.12c-10.791,8.852-22.14,17.112-32.278,26.658
        ...
        c1.706-0.643,3.47-1.138,5.206-1.702C1106.572,12.71,1106.775,12.919,1106.987,13.12z"
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M27.457,12.482c25.558,9.528,51.14,18.991,76.669,28.596
      ...
      <p *ngSwitchDefault>Icon not found</p>
    </ng-container>
  `,
})
